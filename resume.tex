...
\documentclass[11pt, a4paper]{awesome-compact}
...
\name{Shafar}{Muhammad Uliah}
\position{Site Reliability Engineer{\enskip\cdotp\enskip}Software Architect}
\address{7, Handayani st., Ujung, Parepare, Indonesia, 91112}

\mobile{(+62) 8135 5190 767}
\email{777uliahshafar@gmail.com}
%\dateofbirth{January 1st, 1970}
%\homepage{www.posquit0.com}
%\github{posquit0}
\linkedin{uliah-shafar}
% \gitlab{gitlab-id}
...
\googlescholar{mGfgvcgAAAAJ}{Shafar, M. Uliah}
